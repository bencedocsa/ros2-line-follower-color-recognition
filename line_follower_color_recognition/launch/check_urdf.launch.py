...
def generate_launch_description():
    ...
    pkg_line_follower_color_recognition = FindPackageShare('line_follower_color_recognition')
    default_rviz_config_path = PathJoinSubstitution([pkg_line_follower_color_recognition, 'rviz', 'urdf.rviz'])
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'line_follower_color_recognition',
