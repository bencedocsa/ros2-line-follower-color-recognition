...
def generate_launch_description():
    ...
    world_arg = DeclareLaunchArgument(
        'world', default_value='track_dark.sdf',
    ...
    rviz_config_arg = DeclareLaunchArgument(
        'rviz_config', default_value='simulation.rviz',
    ...
    line_follower_cnn_node = Node(
        package='line_follower_color_recognition_py',
    ...
    ld.add_action(line_follower_cnn_node)
